  ...
  const content = (
    <Animated.View style={[styles.content, enterStyle]} pointerEvents="box-none">
      ...
      <View style={[styles.hero, { alignItems: 'center', marginBottom: spacing.lg, paddingTop: spacing.sm }]}>
        ...
        <Text style={[styles.heroSubtitle, { ...typography.body, color: colors.textSecondary, marginTop: spacing.xxs }]}>
      ...
      >
        <View
          style={[
            styles.inputWrap,
            {
              borderColor: borderColor(emailFocused),
        ...
        <View
          style={[
            styles.inputWrap,
            {
              borderColor: borderColor(passwordFocused),
